...
#' @param se SummarizedExperiment,
#' Data object with missing values.
#' @param cluster_columns clustering columns or not. default TRUE.
...
#' plot_missval(filt)
#' @export
plot_missval <- function(se, cluster_columns=TRUE) {
    ...
    # all protein used
    # missval <- as.matrix(df); missval[is.na(missval)]=0; missval[missval!=0]=1
